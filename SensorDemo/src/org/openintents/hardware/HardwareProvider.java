...
public class HardwareProvider extends ContentProvider {
	...
	public Cursor query(Uri url, String[] projection, String selection,
		...
		case PREFERENCES:
			...
			defaultOrderBy = org.openintents.provider.Hardware.Preferences.DEFAULT_SORT_ORDER;
			break;
	...
	public Uri insertPreferences(Uri url, ContentValues values) {
		...
		if (!values.containsKey(org.openintents.provider.Hardware.Preferences.NAME)) {
			values.put(org.openintents.provider.Hardware.Preferences.NAME, "new item");
		}
		
		if (!values.containsKey(org.openintents.provider.Hardware.Preferences.VALUE)) {
			values.put(org.openintents.provider.Hardware.Preferences.VALUE, "");
		}
