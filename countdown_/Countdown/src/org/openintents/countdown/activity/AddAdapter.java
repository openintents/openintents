...
// Based on AddAdapter from the Launcher application.
...
public class AddAdapter extends BaseAdapter {
    ...
    public static final int ITEM_AUTOMATION_TASK = 1;
    ...
    public AddAdapter(Context context) {
        ...
        mItems.add(new ListItem(res, R.string.group_automation_tasks,
                R.drawable.ic_launcher_appwidget, ITEM_AUTOMATION_TASK));
