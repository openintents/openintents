...
package org.openintents.countdown.activitypicker;
 ...
 */
public class ActivityPickerDialog implements
    ...
    public Dialog createDialog(Activity activity) {
        ...
        mAdapter = new PickAdapter(mActivity, items);
    ...
    */
    ...
    protected List<PickAdapter.Item> getItems() {
        ...
        if (labels != null && icons != null && labels.size() == icons.size()) {
            for (int i = 0; i < labels.size(); i++) {
                ...
                items.add(new PickAdapter.Item(mActivity, label, icon));
            }
        }
    ...
    protected void putIntentItems(Intent baseIntent, List<PickAdapter.Item> items) {
        ...
        for (int i = 0; i < listSize; i++) {
            ...
            items.add(new PickAdapter.Item(mActivity, packageManager, resolveInfo));
        }
    }
