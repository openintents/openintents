...
short_lang=("de" "es" "fr" "ko" "lo" "nl" "pt" "ro" "ru") #do not include template language ("en" usually).
#="nl" "de" "fr" "ar" "es" "he" "hu" "id" "it" "pl" "pt_BR" "ru" "sv" "zh_CN"
long_lang=("de" "es" "fr" "ko" "lo" "nl" "pt" "ro" "ru") #do not include template language ("en" usually).
