 ...
 * Original file: C:\\Users\\Admin\\workspace\\DependencyManagerTestApp\\externals\\client\\src\\de\\finkhaeuser\\dm\\IDependencyManager.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements de.finkhaeuser.dm.IDependencyManager
{
 ...
 */
public static de.finkhaeuser.dm.IDependencyManager asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof de.finkhaeuser.dm.IDependencyManager))) {
return ((de.finkhaeuser.dm.IDependencyManager)iin);
}
return new de.finkhaeuser.dm.IDependencyManager.Stub.Proxy(obj);
}
...
private static class Proxy implements de.finkhaeuser.dm.IDependencyManager
{
...
/**
   ...
   * honours the org.openintents.dm.extras.COMPONENT_TYPE extra as set by
