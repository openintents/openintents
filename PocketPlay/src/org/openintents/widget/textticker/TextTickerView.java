 ...
 *
 */
public class TextTickerView extends View {
	private static final String TAG = "TextTickerView"; 
     ...
     * @param context
     */
    public TextTickerView(Context context) {
		super(context);
		initTextTicker();
	}
     ...
     */
    public TextTickerView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onDraw(Canvas canvas) {
		...
		} else if (mCurrentStartingOffset < -mTextWidth) {
			mCurrentStartingOffset = width;
		}
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if (msg.what == MSG_KINETIC_SCROLLING) {
				...
				mOldTime = time;
				if (oldOffset > 0 && mCurrentStartingOffset <= 0) {
