...
public class MessageCursorTreeAdapter extends SimpleCursorTreeAdapter {
	...
	public MessageCursorTreeAdapter( Context context,Cursor cursor, int groupLayout,
	...
	//	{
		...
		Log.d(_TAG,"::getChildrenCursor: dumping groupCursor:\n"+dumpCursor(groupCursor)+"\n-------------------------------------");
			 ...
			 childCursor=News.mContentResolver.query(
				...
				RSS_SUB_PROJECTION,
				News.RSSFeedContents.CHANNEL_ID+"="+channelID+" AND "
				+News.RSSFeedContents._ID+"="+itemID,
				null,
				null
				);
