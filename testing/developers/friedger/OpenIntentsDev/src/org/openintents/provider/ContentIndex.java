...
public class ContentIndex {
	...
	public static final class Dir implements BaseColumns {
		 ...
		 */
		public static final ContentURI CONTENT_URI = ContentURI
				.create("content://org.openintents.contentindices/directories");
	 ...
	 * @return
	 */
	public Cursor getContentBody(ContentURI uri) {
		ContentURI entryUri = Entry.CONTENT_URI.addQueryParameter(QUERY_CONTENT_BODY_URI, uri
				.toString());
		return mResolver.query(entryUri, null, null, null, null);
	}

	public final int updateDirectory(Directory directory) {
		ContentURI uri = Dir.CONTENT_URI.addId(directory.id);
	 ...
	 */
	public final ContentURI addDirectory(Directory directory) {
		ContentURI uri = Dir.CONTENT_URI;
