...
public class PackageList extends ListActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, PACKAGE_ADD_ID, R.string.menu_package_add).setShortcut(
				KeyEvent.KEYCODE_3, 0, KeyEvent.KEYCODE_I);
		return true;
	}
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		if (haveItems) {
			menu.add(Menu.SELECTED_ALTERNATIVE, PACKAGE_DEL_ID,
					R.string.menu_package_del).setShortcut(KeyEvent.KEYCODE_5,
					0, KeyEvent.KEYCODE_U);
	...
	private void deletePackage() {
		...
		AlertDialog.show(this, title, msg, cancel, c1, ok, c1, true, c2);
	}
