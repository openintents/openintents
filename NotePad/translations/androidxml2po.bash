...
short_lang=("de" "es" "fi" "fr" "it" "ja" "ko" "lo" "nl" "pl" "ro" "ru") #do not include template language ("en" usually).
#="nl" "de" "fr" "ar" "es" "he" "hu" "id" "it" "pl" "pt_BR" "ru" "sv" "zh_CN"
long_lang=("de" "es" "fi" "fr" "it" "ja" "ko" "lo" "nl" "pl" "ro" "ru") #do not include template language ("en" usually).
