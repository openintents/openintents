...
short_lang=("de" "es" "fo" "fr" "it" "ja" "ko" "nl" "pl" "ro" "ru") #do not include template language ("en" usually).
#"de" "fr" "ar" "es" "he" "hu" "id" "it" "pl" "pt_BR" "ru" "sv" "zh_CN"
long_lang=("de" "es" "fo" "fr" "it" "ja" "ko" "nl" "pl" "ro" "ru") #do not include template language ("en" usually).
