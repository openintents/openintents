...
short_lang=("de" "es" "fr" "ja" "lo" "nl" "pt" "zh_CN") #do not include template language ("en" usually).
#="nl" "de" "fr" "ar" "es" "he" "hu" "id" "it" "pl" "pt_BR" "ru" "sv" "zh_CN"
long_lang=("de" "es" "fr" "ja" "lo" "nl" "pt" "zh-rCN") #do not include template language ("en" usually).
