...
short_lang=("cs" "de" "es" "fr" "it" "ja" "ko" "lo" "nl" "oc" "pl" "pt" "ro" "ru" "sk" "zh_CN") #do not include template language ("en" usually).
#="nl" "de" "fr" "ar" "es" "he" "hu" "id" "it" "pl" "pt_BR" "ru" "sv" "zh_CN"
long_lang=("cs" "de" "es" "fr" "it" "ja" "ko" "lo" "nl" "oc" "pl" "pt" "ro" "ru" "sk" "zh-rCN") #do not include template language ("en" usually).
...
launchpad_po_filename="aboutapp"
