...
public class AboutIntents {
	 ...
	 * 		3. Put the name of the image resource as a String in "logo". This is the part you would append after "R.drawable." but with type and package as a prefix also. Actually it's good to use the result from "getResources().getResourceName(R.drawable.icon)". If you do this, you also need to put the package of your application (and thus the package containing the image resource) in "org.openintents.extra.LOGO_PACKAGE" (see EXTRA_LOGO_PACKAGE below) as a String.
	 * 
	 * <p>Constant Value: "org.openintents.extra.LOGO"</p>
	 */
	 ...
	 */
	public static final String EXTRA_PROGRAM_NAME = "org.openintents.extra.PROGRAM_NAME";
	/**
	 * Intent extra key for:
	 ...
	 */
	public static final String EXTRA_PROGRAM_VERSION = "org.openintents.extra.PROGRAM_VERSION";
	/**
	 * Intent extra key for:
	 * Comments about the program. This string is displayed in a label in the main dialog, thus it should be a short explanation of the main purpose of the program, not a detailed list of features.
	 * 
	 * <p>Constant Value: "org.openintents.extra.COMMENTS"</p>
	 */
	 ...
	 * 
	 * <p>Constant Value: "org.openintents.extra.WEBSITE_URL"</p>
	 */
	public static final String EXTRA_WEBSITE_URL = "org.openintents.extra.WEBSITE_URL";
	/**
	 * Intent extra key for:
	 * The label for the link to the website of the program. If this is not set, it defaults to the URL specified in the "org.openintents.extra.WEBSITE_URL" property.
	 * 
	 * <p>Constant Value: "org.openintents.extra.WEBSITE_LABEL"</p>
	 */
	 ...
	 * 
	 * <p>Constant Value: "org.openintents.extra.AUTHORS"</p>
	 */
	 ...
	 * 
	 * <p>Constant Value: "org.openintents.extra.DOCUMENTERS"</p>
	 */
	public static final String EXTRA_DOCUMENTERS = "org.openintents.extra.DOCUMENTERS";
	/**
	 * Intent extra key for:
	 * The people who made the translation for the current localization, as an array of strings. Each string may contain email addresses and URLs, which will be displayed as links. Only list those for the currently used/shown L10n.
	 * 
	 * <p>Constant Value: "org.openintents.extra.TRANSLATORS"</p>
	 */
	 ...
	 */
	public static final String EXTRA_WRAP_LICENSE = "org.openintents.extra.WRAP_LICENSE";
